...
| =j= / =k= | Move down / up          |
| =l=       | Open log buffer         |
| =b=       | Return to status buffer |

** Status buffer

| Key     | Action                               |
|---------+--------------------------------------|
| =s=     | Stage file, hunk, or line at point   |
| =u=     | Unstage file, hunk, or line          |
| =V=     | Enter visual mode (multi-line select) |
| =S=     | Stage all unstaged changes           |
| =U=     | Unstage all staged changes           |
| =x=     | Discard file or hunk at point        |
| =c=     | Open commit menu                     |
